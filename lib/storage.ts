...
export const initializeDemoData = (force: boolean = false) => {
    ...
    if (existingDoctors.length < 7 || force) {
        const demoDoctors: Doctor[] = [
            ...
            { id: "d2", name: "Dr. Kanagarathinam", specialization: "Dental practitioner", phone: "98765432", email: "kanag@clinic.com", isActive: true, isAvailable: true, slotDuration: 30, photo: "https://res.cloudinary.com/dhgwe2rz3/image/upload/v1766474647/dental-clinic/homepage/Dr_Kanagarathinam.png" },
            { id: "d3", name: "Dr. Durshayine", specialization: "Dental practitioner", phone: "92345678", email: "dursh@clinic.com", isActive: true, isAvailable: true, slotDuration: 20, photo: "https://res.cloudinary.com/dhgwe2rz3/image/upload/v1766474662/dental-clinic/homepage/Dr.Durshayine.png" },
